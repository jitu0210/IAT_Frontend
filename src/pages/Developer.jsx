...
export default function Developers() {
  return (
    <div className="bg-gradient-to-br from-black to-gray-900 text-gray-200 min-h-screen flex flex-col overflow-x-hidden">
      <Header />

      {/* Hero Section */}
      <section className="py-8 md:py-16 bg-gradient-to-r from-blue-900/30 to-purple-900/30 text-center px-4">
      ...
      {/* Developer Cards */}
      <section className="flex-grow py-8 md:py-16 px-4">
        <div className="max-w-7xl mx-auto grid gap-6 sm:gap-8 md:gap-12 grid-cols-1 md:grid-cols-2">
          {developers.map((dev, index) => (
            ...
            >
              {/* Decorative element */}
              <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 md:w-32 md:h-32 bg-blue-500/10 rounded-full -translate-y-8 sm:-translate-y-10 md:-translate-y-16 translate-x-4 sm:translate-x-6 md:translate-x-8 blur-xl"></div>

              <div className="flex flex-col sm:flex-row items-center mb-6">
                <div className="bg-gradient-to-br from-blue-500 to-purple-500 p-1 rounded-full sm:mr-4 mb-4 sm:mb-0 flex-shrink-0 w-16 h-16 sm:w-16 sm:h-16 mx-auto sm:mx-0">
              ...
              <div className="space-y-4 pt-4 border-t border-gray-800">
                <div className="flex flex-col">
                  ...
                  <a
                    ...
                    className="text-blue-400 hover:text-blue-300 transition-colors flex items-center text-xs sm:text-sm md:text-base break-all min-h-[1.5rem]"
                ...
                <div className="flex flex-col">
                  ...
                  <a
                    ...
                    className="text-blue-400 hover:text-blue-300 transition-colors flex items-center text-xs sm:text-sm md:text-base break-words min-h-[1.5rem]"
      ...
      {/* General Contact */}
      <section className="py-10 sm:py-12 md:py-16 bg-gradient-to-r from-blue-900/20 to-purple-900/20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 md:gap-8">
            <div className="bg-gray-900/50 p-4 sm:p-6 rounded-lg md:rounded-xl border border-gray-800 flex-1 max-w-xs mx-auto sm:max-w-none  flex flex-col justify-between">
              <div>
                <svg
            ...
            <div className="bg-gray-900/50 p-4 sm:p-6 rounded-lg md:rounded-xl border border-gray-800 flex-1 max-w-xs mx-auto sm:max-w-none flex flex-col justify-between">
              ...
              <a
                ...
                className="text-blue-400 hover:text-blue-300 transition-colors text-sm sm:text-base md:text-lg font-medium break-words"
