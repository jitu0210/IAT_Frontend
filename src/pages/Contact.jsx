      ...
      <section className="relative py-10 bg-gradient-to-r from-gray-900 to-black overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-8">
            ...
            and guidance. Reach out to the right department for prompt
            assistance.
          </p>
              ...
              {contacts.map((contact, index) => (
                ...
                >
                  ...
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h2
                        className={`text-2xl font-bold bg-gradient-to-r ${contact.color} bg-clip-text text-transparent`}
                      >
                        {contact.title}
                      </h2>
                  ...
                  <div className="space-y-5">
                    <div className="flex items-start group">
                      ...
                      <div>
                        ...
                        <p className="font-medium group-hover:text-blue-300 transition-colors duration-300">
                          {contact.acronym}
                        </p>
                      </div>
                    </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="group">
                    <label
                      htmlFor="name"
                      className="block text-sm font-medium text-gray-400 mb-2 group-hover:text-blue-300 transition-colors"
                    >
                      Full Name *
                    </label>
                    <input
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {teamMembers.map((member, index) => (
                  <div
                    key={index}
                    className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group"
                  >
