    ...
    <div className="bg-gradient-to-br from-black to-gray-900 text-white flex flex-col min-h-screen">
      ...
      <div
        className={`sticky top-0 z-50 transition-all duration-300 ${
          isScrolled ? "bg-gray-900/95 py-2 shadow-xl" : "bg-gray-900/90 py-6"
      ...
      <section className="relative py-16 md:py-24 bg-gradient-to-r from-blue-900/30 to-purple-900/30 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl md:max-w-4xl mx-auto leading-relaxed font-light">
            Pioneering excellence in electronics and electrical solutions for
            over three decades, empowering industries with innovative
      ...
      <section
        id="overview"
        className={`py-16 md:py-24 transition-all duration-500 ${
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              <div className="flex items-center mb-4 md:mb-6">
                ...
                <span className="text-blue-400 font-semibold tracking-wide text-xs md:text-sm">
                  OUR JOURNEY
                </span>
              </div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 md:mb-8 text-white tracking-tight">
                Our Story
              </h2>
              <p className="text-gray-300 mb-4 md:mb-6 leading-relaxed text-base md:text-lg">
                Aartech Solonics Limited (formerly known as Aartech Energies
                Limited) is a leading technology company providing solutions in
                power electronics, automation, energy management, and
                manufacturing. Established in 1987, we've grown from a small
                entrepreneurial venture to a respected name in the industry with
                a pan-India presence and global aspirations.
              </p>
              <p className="text-gray-300 leading-relaxed text-base md:text-lg">
                Our journey reflects our commitment to innovation, quality, and
                customer satisfaction. We take pride in our ability to adapt to
                changing market dynamics while maintaining our core values of
                integrity and excellence. Listed on the Bombay Stock Exchange
                (BSE: 524120), we continue to expand our capabilities and market
                reach.
              </p>
            </div>
            <div className="relative mt-8 md:mt-0">
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-2xl p-6 md:p-8 h-64 md:h-80 flex items-center justify-center transform transition-all duration-500 hover:scale-105">
                <div className="text-center relative z-10">
                  <div className="text-5xl md:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 mb-2">
                    35+
                  </div>
      ...
      <section
        id="mission"
        className={`py-16 md:py-24 bg-gradient-to-br from-gray-900 to-black transition-all duration-500 ${
          isSectionVisible("mission") ? "opacity-100 block" : "opacity-0 hidden"
        }`}
      >
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-4xl lg:max-w-6xl mx-auto">
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-2xl p-6 md:p-8 lg:p-10 h-full transform transition-all duration-300 hover:-translate-y-1">
                <div className="text-cyan-400 text-4xl md:text-5xl mb-6 md:mb-8">
                  🎯
                </div>
                <h3 className="text-xl md:text-2xl font-bold text-cyan-400 mb-4 md:mb-6">
                  Mission
                </h3>
                <p className="text-gray-300 leading-relaxed text-base md:text-lg">
                  To provide innovative, reliable, and sustainable technology
                  solutions that empower industries to optimize their
                  operations, reduce energy consumption, and enhance
                  productivity. We strive to exceed expectations through
                  technological excellence, quality products, and unparalleled
                  customer service.
                </p>
              </div>
            </div>
            ...
            <div className="relative group mt-8 md:mt-0">
              ...
              <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-2xl p-6 md:p-8 lg:p-10 h-full transform transition-all duration-300 hover:-translate-y-1">
                <div className="text-blue-400 text-4xl md:text-5xl mb-6 md:mb-8">
                  🔭
                </div>
                <h3 className="text-xl md:text-2xl font-bold text-blue-400 mb-4 md:mb-6">
                  Vision
                </h3>
                <p className="text-gray-300 leading-relaxed text-base md:text-lg">
                  To be a globally recognized technology company providing
                  innovative solutions in power electronics, automation, and
                  energy management. We envision a future where our innovations
                  contribute significantly to sustainable industrial growth,
      ...
      <section
        id="values"
        className={`py-16 md:py-24 transition-all duration-500 ${
          isSectionVisible("values") ? "opacity-100 block" : "opacity-0 hidden"
        }`}
      >
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 md:mb-20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10 max-w-5xl lg:max-w-7xl mx-auto">
            {[
              ...
              },
              {
                title: "Quality",
                description:
                  "Maintaining the highest standards in all our products and services",
                icon: "⭐",
              ...
              },
              {
                ...
                description:
                  "Committing to environmentally responsible business practices",
                icon: "🌱",
              ...
              },
              {
                title: "Excellence",
                description:
                  "Striving for perfection in execution and delivery",
                icon: "🏆",
              ...
              <div key={index} className="group relative">
                ...
                <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-xl p-6 text-center h-full group-hover:border-gray-600 transition-all duration-300 transform hover:-translate-y-1">
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-r ${value.color} text-white text-2xl md:text-3xl mb-4 md:mb-6`}
                  >
                    {value.icon}
                  </div>
                  <h3
                    className={`text-lg md:text-xl lg:text-2xl font-bold mb-3 md:mb-4 bg-gradient-to-r ${value.color} bg-clip-text text-transparent`}
                  >
                    {value.title}
                  </h3>
            ...
            {[
              {
                ...
                description:
                  "Designing and manufacturing advanced power conversion and control systems for industrial applications",
                features: [
                  "UPS Systems",
                  "Power Supplies",
              ...
              },
              {
                ...
                description:
                  "Providing cutting-edge industrial automation and control systems to enhance operational efficiency",
                features: [
                  "PLC Systems",
                  "SCADA Solutions",
                  "Process Control",
              ...
              },
              {
                ...
                description:
                  "Offering comprehensive energy audit and optimization services for sustainable operations",
                features: [
                  "Energy Audits",
              ...
              },
              {
                ...
                description:
                  "Electronic manufacturing services with state-of-the-art facilities and quality processes",
                features: [
                  "PCB Assembly",
                  "Product Design",
                  "Prototyping",
              ...
              <div key={index} className="relative group">
                ...
                <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-2xl p-6 md:p-8 h-full transform transition-all duration-300 hover:-translate-y-1">
                  <h3
                    className={`text-xl md:text-2xl font-bold mb-4 md:mb-6 bg-gradient-to-r ${vertical.color} bg-clip-text text-transparent`}
                  >
                    {vertical.title}
                  </h3>
                  ...
                  <ul className="space-y-3 md:space-y-4">
                    {vertical.features.map((feature, i) => (
                      <li key={i} className="flex items-start">
                        <span
                          className={`bg-gradient-to-r ${vertical.color} bg-clip-text text-transparent font-semibold mr-2 md:mr-3 text-lg md:text-xl`}
                        >
                          •
                        </span>
                ...
                <ul className="space-y-3 md:space-y-4 lg:space-y-5">
                  {[
                    ...
                    <li key={index} className="flex items-start">
                      <span className="text-green-400 mr-3 mt-1 flex-shrink-0 text-lg md:text-xl">
                        ✓
                      </span>
                      <span className="text-gray-300 text-base md:text-lg">
                        {strength}
              ...
              <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-2xl p-6 md:p-8 lg:p-10 h-full transform transition-all duration-300 hover:-translate-y-1">
                ...
                <ul className="space-y-3 md:space-y-4 lg:space-y-5">
                  {[
                    ...
                    <li key={index} className="flex items-start">
                      <span className="text-blue-400 mr-3 mt-1 flex-shrink-0 text-lg md:text-xl">
                        •
                      </span>
                      <span className="text-gray-300 text-base md:text-lg">
                        {certification}
      ...
      <section
        id="clients"
        className={`py-16 md:py-24 bg-gradient-to-br from-gray-900 to-black transition-all duration-500 ${
          isSectionVisible("clients") ? "opacity-100 block" : "opacity-0 hidden"
        }`}
      >
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl md:max-w-3xl mx-auto">
              We proudly serve clients across diverse sectors with our
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-6 lg:gap-8 max-w-4xl md:max-w-5xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-lg md:rounded-xl p-4 md:p-6 text-center transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1"
              >
